  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static"  sx={{ backgroundImage: 'linear-gradient(to bottom right, #D2B48C, #F5DEB3)'}}>
        <Toolbar>
        <Box component="img" src={"https://png.pngtree.com/template/20190316/ourmid/pngtree-books-logo-image_79143.jpg"} alt="book" sx={{  height: 50, marginRight: 103}} align="left" />
